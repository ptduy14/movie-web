...
export default function MoviePage({ movie }: { movie: DetailMovie }) {
  return (
    <div>
      <div
        className="relative w-full h-[35rem] bg-no-repeat bg-cover flex items-end justify-center"
      ...
      >
        ...
        <div className="container-wrapper-movie relative flex justify-end z-10">
          ...
          <div className=" w-3/4 pl-14 pb-8 space-y-10 ">
            <div>
              <h3 className="text-4xl font-medium">{`${movie.movie.origin_name}`}</h3>
              <h4 className="text-xl text-[#bbb6ae] font-normal mt-2">{`${movie.movie.name} (${movie.movie.year})`}</h4>
            </div>
